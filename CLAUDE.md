...
**Current page count:** 609 static pages + 1 serverless API route
...
│       ├── cash4life.json           # ~2,949 draws (2014 to present)
│       ├── ny-lotto.json            # ~2,551 draws (2001 to present)
│       ├── take5.json               # ~12,196 draws (2001 to present, 2x/day)
...
npm run build                  # Build for production (~609 pages)
