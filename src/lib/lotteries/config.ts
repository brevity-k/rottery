...
export const lotteries: Record<string, LotteryConfig> = {
  ...
  'millionaire-for-life': {
    ...
    description: 'Millionaire for Life is New York\'s newest lottery game, replacing Cash4Life. Players choose 5 numbers from 1-58 and 1 Millionaire Ball from 1-5. Drawings are held daily at 11:15 PM ET with a top prize of $1 million per year for life.',
    mainNumbers: { count: 5, max: 58, label: 'Numbers' },
    bonusNumber: { count: 1, max: 5, label: 'Millionaire Ball' },
    drawDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    drawTime: '11:15 PM ET',
    ticketPrice: 5,
    jackpotOdds: '1 in 22,910,580',
    dataSource: {
      type: 'soda',
      url: 'https://data.ny.gov/resource/a4w9-a3tp.json',
      fields: {
        date: 'draw_date',
        numbers: 'winning_numbers',
        bonus: 'mill_ball',
    ...
    website: 'https://nylottery.ny.gov/millionaire-for-life',
    startYear: 2026,
  },
  'ny-lotto': {
    id: 'ny-lotto',
